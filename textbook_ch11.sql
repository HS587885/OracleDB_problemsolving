...
--이름(20), 비밀번호(20), 전화번호(15), 이메일(100)을 포함해야 합니다. 
-- 괄호 안의 숫자는 크기입니다. 회원 정보를 저장하는 테이블은 사용자 아이디를 PK로 갖습니다.
...
--2. 다음 테이블 구문을 수정해서 제약조건을 추가하세요. - DEPT 테이블의 DEPTNO 열은 주키(primary key) 열이어야 합니다. 제약조건의 이름은 pk_dept로 하세요. 
